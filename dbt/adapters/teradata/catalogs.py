...
class TeradataDatalakeCatalogIntegration(CatalogIntegration):
    ...
    def __init__(self, config: CatalogIntegrationConfig) -> None:
        ...
        self.datalake_name = (adapter_props.get("datalake_name") or "").strip() or None
        self.otf_database = (adapter_props.get("otf_database") or "").strip() or None
    ...
    def build_relation(self, config: RelationConfig) -> TeradataCatalogRelation:
        ...
        """
        raw_config = config.config if hasattr(config, 'config') and config.config else {}
        def _get(key: str):
        ...
        return TeradataCatalogRelation(
            ...
            partitioned_by=_get("partitioned_by"),
            sorted_by=_get("sorted_by"),
            tblproperties=_get("tblproperties"),
            purge_mode=_get("purge_mode"),
        )
