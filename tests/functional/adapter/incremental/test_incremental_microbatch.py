...
select 1 as id, TIMESTAMP '2020-01-01 00:00:00' as event_time from SYS_CALENDAR.CALENDAR where day_of_calendar = 1
union all
select 2 as id, TIMESTAMP '2020-01-02 00:00:00' as event_time from SYS_CALENDAR.CALENDAR where day_of_calendar = 1
union all
select 3 as id, TIMESTAMP '2020-01-03 00:00:00' as event_time from SYS_CALENDAR.CALENDAR where day_of_calendar = 1
"""
...
class BaseMicrobatch:
    ...
    def insert_two_rows_sql(self, project) -> str:
        ...
        return f"insert into {test_schema_relation}.input_model (id, event_time) values (4, TIMESTAMP '2020-01-04 00:00:00'); insert into {test_schema_relation}.input_model (id, event_time) values (5, TIMESTAMP '2020-01-05 00:00:00')"
...
class TestMicrobactchTeradata(BaseMicrobatch):
    pass