...
select * from (select
    ...
    cast('2021-05-21' as date) as last_visit_date) as "dual"
union all
select * from ( select 'MA' as state,'Suffolk' as county,'Boston' as city, cast('2020-02-12' as date) as last_visit_date) as "dual"
union all
select * from (select 'NJ' as state,'Mercer' as county,'Trenton' as city,cast('2022-01-01' as date) as last_visit_date) as "dual"
union all
select * from (select 'NY' as state,'Kings' as county,'Brooklyn' as city,cast('2021-04-02' as date) as last_visit_date) as "dual"
union all
select * from (select 'NY' as state,'New York' as county,'Manhattan' as city, cast('2021-04-01' as date) as last_visit_date) as "dual"
union all
select * from (select 'CT' as state,'Hartford' as county,'Hartford' as city, cast('2022-02-14' as date) as last_visit_date) as "dual"
"""
